...
--Part 3: Sensor Data Loaded Into Windows Azure Storage Blob 
...
--Part 4: Creating Hive Tables to Query the Sensor Data in the Windows Azure Blob Storage 
...
STORED AS TEXTFILE LOCATION '/HdiSamples/SensorSampleData/hvac/';
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
STORED AS TEXTFILE LOCATION '/HdiSamples/SensorSampleData/building/';

--Part 5: Creating Hive Queries over Sensor Data 
